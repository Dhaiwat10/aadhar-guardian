...
export interface IAnonAadhaarVerifierInterface extends Interface {
...
export interface IAnonAadhaarVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): IAnonAadhaarVerifier;
  waitForDeployment(): Promise<this>;

  interface: IAnonAadhaarVerifierInterface;
